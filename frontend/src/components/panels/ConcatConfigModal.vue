...
<template>
  <div v-if="show" class="fixed inset-0 bg-gray-900/80 dark:bg-gray-900/80 z-[10000] flex justify-center items-center p-4">
    <FocusTrap :active="show" initialFocus="#config-first-input">
      <div 
        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg w-full max-w-[800px] max-h-[85vh] flex flex-col overflow-hidden shadow-2xl"
        role="dialog"
        aria-modal="true"
      ...
      <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800">
        <h3 id="config-modal-title" class="text-blue-600 dark:text-blue-400 font-bold text-lg">Concat Tool Configuration</h3>
        <button id="config-close-btn" @click="emit('close')" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white transition-colors">
      ...
      <div class="flex-1 overflow-y-auto p-5 space-y-6">
        ...
        <section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
          ...
          <div class="p-4 space-y-4">
            <label class="flex items-center gap-3 cursor-pointer group">
              <input 
                id="config-first-input"
                type="checkbox" 
                v-model="config.ignoreBinaries" 
        ...
        <section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
          ...
          <div class="p-4">
            <label for="skip-dirs-input" class="sr-only">Excluded Directories</label>
            <textarea 
              id="skip-dirs-input"
        ...
        <section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
          ...
          <div class="p-4">
            <label for="skip-exts-input" class="sr-only">Excluded Extensions</label>
            <textarea 
              id="skip-exts-input"
        ...
        <section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
          ...
          <div class="p-4">
            ...
            <label for="custom-patterns-input" class="sr-only">Custom Patterns</label>
            <textarea 
              id="custom-patterns-input"
        ...
        <section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
          ...
          <div class="p-4 space-y-4">
            ...
            <div class="flex flex-col gap-2">
              <label for="header-style-select" class="block text-sm font-medium text-gray-900 dark:text-white">Header Style</label>
              <select id="header-style-select" v-model="config.headerStyle" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
